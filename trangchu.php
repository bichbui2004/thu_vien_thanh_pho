...
<body>
    ...
    <div class="box-right">
        ...
        $sqlCD = "SELECT MaCD, TenChuDe FROM chu_de ORDER BY MaCD ASC";
        ...
        ?>
            ...
            <h1><?php echo $tenCD; ?></h1>

            
            <div class="product-grid">
                <?php
                $sqlSach = "SELECT * FROM sach WHERE MaCD = $maCD ORDER BY RAND() LIMIT 5";
                $rsSach = mysqli_query($conn, $sqlSach);

                while ($row = mysqli_fetch_assoc($rsSach)) {
                ?>
